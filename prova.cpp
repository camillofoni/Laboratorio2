...
void proviamo() {
  ...
  TH1F *h7 =
      new TH1F("h7", "Massa invariante per cariche discordi", 100, 0, 10);
  h7->Sumw2();
  TH1F *h8 =
      new TH1F("h8", "Massa invariante per cariche concordi", 100, 0, 10);
  h8->Sumw2();
  TH1F *h9 = new TH1F("h9", "Massa invariante per pioni+ e kaoni-", 100, 0, 10);
  h9->Sumw2();
  TH1F *h10 =
      new TH1F("h10", "Massa invariante per pioni- e kaoni+", 100, 0, 10);
  h10->Sumw2();
  TH1F *h11 = new TH1F("h7", "Massa invariante per figlie k*", 100, 0, 3);
  h11->Sumw2();
  ...
  for (int j = 0; j < 1e5; ++j) {
    ...
    for (int i = 0; i < 100; ++i) {
      ...
      } else  // k*
      {
        ...
        h11->Fill(EventParticles[100 + decaycounter].InvMass(
            EventParticles[101 + decaycounter]));
        decaycounter++;
      }
